<div style="margin:0 auto; width:500px; height:630px;padding-top:50px; position:relative; background-image:url({{ $message->embed($image_bg) }});color:black;" align="center">
